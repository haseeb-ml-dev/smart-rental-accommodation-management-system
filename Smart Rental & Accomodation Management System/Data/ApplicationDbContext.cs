...
namespace Smart_Rental___Accomodation_Management_System.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<InfoPage> InfoPages { get; set; } = null!;
        public DbSet<SubscriptionClaim> SubscriptionClaims { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<SupportedArea>()
                .HasOne(a => a.SupportedCity)
                .WithMany()
            ...
            builder.Entity<InfoPage>()
                .HasIndex(p => p.Slug)
                .IsUnique();

            builder.Entity<SubscriptionClaim>()
                .HasOne(c => c.Landlord)
                .WithMany()
